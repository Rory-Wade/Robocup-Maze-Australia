...
while( ( Lidar_Front == -1 || Lidar_Back == -1 || Lidar_Right == -1 || Lidar_Left == -1 || Lidar_Front_Right == -1 || Lidar_Back_Right == -1 || Lidar_Back_Left == -1 || Lidar_Front_Left == -1 ) && stopTimer < 1000){  
