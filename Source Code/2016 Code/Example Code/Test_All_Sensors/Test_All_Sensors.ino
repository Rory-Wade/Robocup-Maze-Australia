...
//    Serial.println( read16(MLX90614_RAWIR2) );
    ...
    Serial.println("---------------------------------------------------------");
    Serial.print("Front: "); Serial.print(digitalRead(touchFront)); Serial.println(" ");
    Serial.print("Back: "); Serial.print(digitalRead(touchBack)); Serial.println(" ");
    Serial.print("Front_Right: "); Serial.print(digitalRead(touchFrontRight)); Serial.println(" ");
    Serial.print("Front_Leftt: "); Serial.print(digitalRead(touchFrontLeft)); Serial.println(" ");
    Serial.print("Back_Right: "); Serial.print(digitalRead(touchBackRight)); Serial.println(" ");
    Serial.print("Back_Left: "); Serial.print(digitalRead(touchBackLeft)); Serial.println(" ");
    Serial.println("---------------------------------------------------------");
    Serial.println(" ");Serial.println(" ");Serial.println(" ");Serial.println(" ");

    delay(30); // Sensors Refresh @ 2Hz
}
